...
def build_facts(results_dir, config=CONFIG):
    ...
    facts = {
        ...
        "prophet_mape_holdout": round(float(prophet[prophet["fold"] == "holdout"]["mape"].mean()), 2),
        "prophet_wape_holdout": round(float(prophet[prophet["fold"] == "holdout"]["wape"].mean()), 2),
        "sarima_mase_holdout": round(float(sarima[sarima["fold"] == "holdout"]["mase"].mean()), 3),
        "sarima_mape_holdout": round(float(sarima[sarima["fold"] == "holdout"]["mape"].mean()), 2),
        "sarima_wape_holdout": round(float(sarima[sarima["fold"] == "holdout"]["wape"].mean()), 2),
